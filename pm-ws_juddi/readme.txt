...
To run using appassembler plugin:
  On Windows:
    target\appassembler\bin\ttt-ws_juddi.bat http://localhost:9090 TTT http://localhost:8080/ttt-ws/endpoint
  On Linux:
    ./target/appassembler/bin/ttt-ws_juddi http://localhost:9090 TTT http://localhost:8080/ttt-ws/endpoint
